    ...
    return(
        <div className='flex  items-center bg-white mt-4 lg:mt-[-52px] px-8 shadow-lg max-w-[1240px] max-l-[240px]  p-4 lg:text-left text-center h-full  items-center   mx-auto rounded-lg'>
            ...
            <div className='w-full md:w-1/2 lg:w-1/2 '>
                ...
                <input type='text' list='from' className='border rounded-md  p-3 lg:w-[300px] w-full' placeholder='Lahore'
          ...
          <div className='w-full md:w-1/2 lg:w-1/2 '>
            ...
            <input type='text' list='to' className='border rounded-md  p-3 lg:w-[300px] w-full' placeholder='Lahore'
